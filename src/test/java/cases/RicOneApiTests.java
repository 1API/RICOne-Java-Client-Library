...
public class RicOneApiTests
{
    ...
    // Lea:
//  static String refId = "03ACF04F-DC12-411A-9A42-E8323516D699";
//	static String idType = "beds";
//	static String id = "530501060000";
//	static String idType = "local";
//	static String id = "530501";
    // School:
//	static String refId = "AE6B3441-5E31-4573-BADB-081669D79C7F";
//	static String idType = "beds";
//	static String id = "530501060004";
//	static String idType = "local";
//	static String id = "shm";
    // Calendar:
//	static String refId = "C419EBD3-5EFC-449C-8890-28545663350F";
    // Course:
//	static String refId = "50F2377E-29BD-45C6-950C-C41B3432FC0A";
    // Roster:
//	static String refId = "00BAD4F5-9CF4-4D49-A8CC-666D02180300";
    //	 Staff:
//	static String refId = "0C6E7BFA-4E4E-4F82-BCE8-C27729A79F29";
	//Student:
//	static String refId = "3089EF6E-143D-4C58-ABF3-8CED68B7AEEE";
    // Contact 1:
//	static String refId = "0BFFDDCF-B25C-423B-BC65-553DE0B95F4B";
...
//			XContacts_GetXContactsByXStudent(xPress);
	...
	public static void XLeas_GetXLeaById(XPress xPress) throws AuthenticationException {
		if (xPress.getXLea(idType, id).getData() != null) {
			XLeaType lea = xPress.getXLea(idType, id).getData();
			System.out.println("refId: " + lea.getRefId());
			System.out.println("leaName: " + lea.getLeaName());
			System.out.println("leaRefId: " + lea.getLeaRefId());
			System.out.println("localId: " + lea.getLocalId());
