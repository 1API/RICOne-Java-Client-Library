...
@XmlType(name = "xEmploymentType", namespace = "http://www.sifassociation.org/datamodel/na/3.2", propOrder = {"type", "manager", "hireDate", "terminationDate", "active", "removeEmployee", "assignments", "metadata"})
public class XEmploymentType extends GSIFCompositeType implements IType<XEmploymentType> {
