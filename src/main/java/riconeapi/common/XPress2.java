...
public class XPress2
{
	...
	/* navigationLastPage */
	public int getLastPage(int navigationPageSize, GetLastPagePath.ServicePath p, String refId)
	{
		return getLastPagePath.getLastPage(navigationPageSize, p, refId);
	}

	public int getLastPage(int navigationPageSize, GetLastPagePath.ServicePath p)
	{
